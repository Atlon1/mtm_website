        ...
        <header
            ...
            <div
                ...
                <div className='flex flex-row gap-4 items-center'>
                    ...
                    <Link href='tel:+48690544645'
                          className='xl:flex hidden hover:text-accent transition-all duration-300'>690544645</Link>
                    <Link href='emailto:mtm.biuro.solution@gmial.com'
                          className='text-accent hover:text-white transition-all duration-300'>
                        <MdOutlineAlternateEmail/>
                    </Link>
                    <Link href='mailto:mtm.biuro.solution@gmial.com'
                          className='xl:flex hidden hover:text-accent transition-all duration-300'>mtm.biuro.solution@gmial.com</Link>
            ...
            <div className="container mx-a h-full flex items-center justify-between">
                ...
                <div className='flex items-center gap-4'>
                    ...
                    <button onClick={() => setOpenNav(!openNav)}
                            className='text-white xl:hidden transition-all duration-300'>
